...
{#if banner?.display}
    <div class="fixed top-16 left-0 bg-primary-600 w-full h-12 z-40">
        <div class="max-w-screen-lg w-full mx-auto flex flex-row items-center justify-center h-full relative">
            ...
            <button class="absolute right-2 top-2 bottom-2 rounded-md hover:bg-primary-300 text-neutral-900 group aspect-square flex flex-col items-center justify-center" name="close" on:click={removeBanner}>
