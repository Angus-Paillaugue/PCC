...
<section class="grow p-4 lg:p-6 mx-auto max-w-4xl w-full">
  ...
  <p>
    Pandabuy Currency Conversion operates the website <a
      class="link"
      href={websiteLocation?.href ?? ''}>{websiteLocation?.hostname ?? 'PCC'}</a
  ...
  <p>
    ...
    name, email address, postal address, and phone number ("Personal
    Information").
  </p>
  ...
  <p>
    ...
    except with respect to any changes in its provisions in the future, which
