...
{#if stripe}
    <section class="py-8 px-4 mx-auto max-w-xl lg:py-16 lg:px-6 w-full grow">
        <div class="text-neutral-900 bg-white rounded-lg border border-neutral-100 shadow p-6">
            ...
            <form on:submit|preventDefault={submit} class="flex flex-col gap-4 mt-2">
                <Elements {stripe}>
                    ...
                    {#if error}
                        <div class="flex flex-row gap-2 items-center text-red-900 bg-red-100 border border-red-600 rounded-md p-4 w-full">
                    ...
                    {#if success}
                        <div class="flex flex-row gap-2 items-center text-green-900 bg-green-100 border border-green-600 rounded-md p-4 w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                            </svg>
