<script>
    ...
    const { extensions, getBrowserType, premiumPrice } = data;
    let extension;
...
<section class="bg-white dark:bg-neutral-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div class="space-y-8 grid grid-cols-1 lg:grid-cols-2 sm:gap-6 xl:gap-10 lg:space-y-0">
            <!-- Pricing Card -->
            <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-neutral-900 bg-white rounded-lg border border-neutral-100 shadow w-full h-fit">
                ...
                <a href="{extension?.link}" class="button-primary button-small">Choose plan</a>
            </div>
            <!-- Pricing Card -->
            <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-neutral-900 bg-white rounded-lg border border-neutral-100 shadow w-full h-fit">
                ...
                <ul role="list" class="mb-8 text-left">
                    ...
                    <ul class="pl-10 block list-inside list-disc">
                        ...
                        <li>
                            <span>Disable product warnings</span>
                        </li>
                        <li>
                            <span>Third party disclaimer auto check</span>
                        </li>
                        <li>
