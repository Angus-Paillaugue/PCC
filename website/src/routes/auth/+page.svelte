...
<section class="justify-between w-full grid grid-cols-1 gap-6 lg:grid-cols-2 grow items-center">
    <img src="pandabuyLogo.webp" alt="" class="lg:max-h-96 max-h-64 mx-auto">
    <div class="w-full max-lg:flex max-lg:items-center max-lg:flex-col p-2">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="relative overflow-hidden grid grid-cols-2 w-full">
                <form class="w-[200%] transition-all ease-in-out duration-300 p-3 pb-5 {tabIndex === 0 ? "translate-x-0" : "translate-x-full"}" use:enhance method="POST" action="?/login" id="Log-in" on:submit={(e) => {isFormLoading = true;}}>
                ...
                <form class="w-[200%] transition-all ease-in-out duration-300 p-3 pb-5 {tabIndex === 1 ? "-translate-x-1/2" : "-translate-x-[150%]"}" use:enhance method="POST" action="?/signin" id="Sign-in" on:submit={(e) => {isFormLoading = true;}}>
