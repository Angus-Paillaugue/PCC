...
<svelte:head>
    ...
    <meta name="description" content="About PCC">
</svelte:head>
            ...
            <div class="flex flex-col items-center justify-center relative max-w-[250px]">
                ...
                <div class="flex flex-row items-center justify-center gap-6 mt-2 text-neutral-600 dark:text-neutral-400">
                    <a href="{member.githubProfileUrl}" target="_blank">
                        <Icon icon="carbon:logo-github" class="w-8 h-8 hover:text-neutral-800 dark:hover:text-neutral-600 transition-all" />
                    </a>
                    <a href="{member.linkedinProfileUrl}" target="_blank">
                        <Icon icon="carbon:logo-linkedin" class="w-8 h-8 hover:text-neutral-800 dark:hover:text-neutral-600 transition-all" />
                    </a>
                </div>
            </div>
        {/each}
