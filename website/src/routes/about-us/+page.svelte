...
<section class="grow py-8 px-4 mx-auto max-w-4xl lg:py-16 lg:px-6 w-full">
    ...
    <p>Hi, this is Angus, the creator of our beloved Pandabuy Currency Conversion navigator extension and this is my team.</p>
